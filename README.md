...
* **Key Focus Areas:**
    ...
    * 🤝 **Soft Skills:** Leadership styles, motivation theories, and teamwork.

## ⚙️ Prerequisites

To view the files correctly, ensure you have:
* **Microsoft PowerPoint** (for presentations)
* **PDF Viewer** (universal format)

---

## 📂 Assignments & Presentations

| ID | Topic | Key Concepts / Focus | Link |
| :-: | :--- | :--- | :-: |
| **01** | **Classical Theory** | **Frederick W. Taylor:** Scientific Management, Efficiency, & Taylorism. | [📂](/Presentations/FrederickWinslowTaylor) |
| **02** | **Company Culture** | **Netflix:** Company Culture, "Freedom & Responsibility", & HR innovation. | [📂](/Presentations/Netflix) |
| **03** | **Sector Analysis** | **Healthcare Management:** Administration challenges, Resource allocation, & Ethics. | [📂](/Presentations/HealthcareManagment) |
